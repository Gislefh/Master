"""
Function: open_bag. Opens, filters and interpolates a bag, returns the variables.
also found in my_lib
"""
...
name = 'hal_control_2018-12-11-11-49-22_0'
bagFile_path = path + name + '.bag'



"""  ------OPEN BAG-------- 
Opens, filters and interpolates a bag
_IN_ 
...
X = open_bag(bagFile_path, plot = False)
